import { n as __esmMin } from "./rolldown-runtime-CE-6LUnI.mjs";
import { a as init_esm_min, i as formDataToBlob, o as init_fetch_blob, r as FormData, s as init_from, t as Blob } from "./from-CDCiFKe-.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/src-BmbbDW2z.js
/**
	...
	Body = class {
		...
		*/
		...
		async formData() {
			...
			const { toFormData } = await import("./multipart-parser-t1A5CJpH.mjs");
