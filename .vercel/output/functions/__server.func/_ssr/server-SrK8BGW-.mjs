...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-hhzPz29m.mjs");
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-SrK8BGW-.js
var server_SrK8BGW__exports = /* @__PURE__ */ __exportAll({
	getCookie: () => getCookie,
	i: () => setCookie,
	n: () => getResponse,
	r: () => requestHandler,
...
//#endregion
export { server_YsuKXrOZ_exports as a, setCookie as i, getCookie as n, server_SrK8BGW__exports as r, deleteCookie as t };
